...
public class TestController {
    private String propertiesFileName = "src/Unit2/files/properties.xml";
    ...
    private Map<String, Integer> skills; //current levels of difficulty for each theme
     ...
     */
    private void normalStep(String[] answer) {
     ...
     */
    private boolean continueAsking(int iteration, int length) {
        return (iteration < length && iteration < NUMBER_OF_QUESTIONS);
    }
